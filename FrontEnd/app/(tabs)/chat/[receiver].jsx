            ...
            <View className="bottom-0 absolute w-full">
                <Animated.View className="bg-gray-100 dark:bg-gray-700" style={[styles.inputContainer, { transform: [{ translateY }] }]}>
                    <View className="ml-0.5">
                        ...
                        } className="bg-white dark:bg-dark-primary/50 w-fit mr-16 h-10 dark:text-dark-text text-text border-gray-700/80 dark:border-none dark:active:bg-primary/10 active:bg-gray-600/10 rounded-lg border-4 font-medium p-0.5 pl-2.5" placeholder="Type a message" onChangeText={(text) => message.current = text}></TextInput>
