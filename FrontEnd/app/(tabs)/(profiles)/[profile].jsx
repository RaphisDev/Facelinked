                        ...
                        <View>
                            <TouchableOpacity onPress={() => {
                                ...
                                <View className="flex-row items-center">
                                    <Image source={{uri: item.item.profilePicturePath}} style={{width: 48, height: 48, borderRadius: 24}} className="bg-gray-200"></Image>
                                    ...
                                    <View className="w-full aspect-square rounded-xl mb-4 relative bg-transparent">
                                        ...
                                        >
                                            <Image
                                                ...
                                                contentFit="cover"
                                                alt="Profile picture"
                                                source={{uri: profileInfos.profilePicturePath}}
                                            />
