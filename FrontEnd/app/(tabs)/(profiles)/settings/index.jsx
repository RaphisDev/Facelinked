           ...
           <ScrollView className="h-full w-full">
               <View className="self-center w-11/12 mt-5 rounded-xl overflow-hidden items-center">
                   <TouchableOpacity activeOpacity={0.7} onPress={() => router.push("/settings/account")}
                                     className="p-1 bg-white active:bg-gray-400 dark:active:bg-dark-primary dark:bg-dark-primary border-gray-500 w-full">
                   ...
                   <TouchableOpacity activeOpacity={0.7} onPress={() => router.push("/settings/legal")}
                                     className="p-1 bg-white active:bg-gray-400 border-t dark:active:bg-dark-primary  dark:bg-dark-primary border-b border-gray-500  w-full">
                   ...
                   <TouchableOpacity activeOpacity={0.7} onPress={() => router.push("/settings/credits")}
                                     className="p-1 bg-white dark:active:bg-dark-primary active:bg-gray-400  dark:bg-dark-primary w-full">
