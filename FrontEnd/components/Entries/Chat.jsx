...
export default function Chat(props) {
    ...
    return (
        <TouchableOpacity activeOpacity={0.9} onPress={() => router.navigate(`/chat/${props.receiver}`)}>
            <View className="rounded-xl" style={{backgroundColor: "#d6d6d6", width: 120, marginBottom: 20, height: 150}}>
                <View className="p-7">
