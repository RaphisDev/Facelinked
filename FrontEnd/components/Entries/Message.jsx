...
export default function Message(props) {
    return (
        <View className="p-3" style={{alignItems: props.isSender ? "flex-end" : "flex-start"}}>
            <View className="rounded-xl p-3" style={{backgroundColor: props.isSender ? "#007BFF" : "#6C757D", width: "70%"}}>
